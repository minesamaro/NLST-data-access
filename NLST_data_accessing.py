...
def process_dicom_files(dicom_files, slice_or_folder, slice_num_in_path = None):
    ...
    for file_path in dicom_files:
        ...
        if not manufacturer or not convolution_kernel:
            # Get attribute (0008, 0070) for manufecturer
            manufacturer = ct_1.get((0x0008, 0x0070), None)
            # Get attribute (0018, 1210) for convolution kernel
            convolution_kernel = ct_1.get((0x0018, 0x1210), None)
